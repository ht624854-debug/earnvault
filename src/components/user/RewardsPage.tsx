...
import { Ticket, Inbox, CheckCircle2, Zap, Users, Gift, Clock, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-ev-bg pb-24">
      ...
      <div className="bg-ev-bg border-b border-ev-card-border sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <p className="text-xs text-ev-muted mt-0.5">Enter daily codes to earn rewards</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 space-y-4">
        ...
        {/* Empty State */}
        {availableCodes.length === 0 && myClaims.length === 0 && (
